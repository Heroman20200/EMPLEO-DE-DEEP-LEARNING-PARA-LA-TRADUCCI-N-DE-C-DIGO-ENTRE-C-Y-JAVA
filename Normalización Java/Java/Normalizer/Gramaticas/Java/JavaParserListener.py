...
class JavaParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JavaParser#genericType.
    def enterGenericType(self, ctx:JavaParser.GenericTypeContext):
        pass

    # Exit a parse tree produced by JavaParser#genericType.
    def exitGenericType(self, ctx:JavaParser.GenericTypeContext):
        pass
