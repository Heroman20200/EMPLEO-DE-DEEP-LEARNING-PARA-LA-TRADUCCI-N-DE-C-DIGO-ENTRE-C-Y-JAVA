...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavaParser#methodModifiers.
    def visitMethodModifiers(self, ctx:JavaParser.MethodModifiersContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavaParser#genericType.
    def visitGenericType(self, ctx:JavaParser.GenericTypeContext):
        return self.visitChildren(ctx)
